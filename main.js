...
var _user$project$Main$itemsNameDecoder = A2(
	_elm_lang$core$Json_Decode$field,
	'items',
	_elm_lang$core$Json_Decode$list(
		A2(
			...
			_elm_lang$core$Json_Decode$string)));
var _user$project$Main$filterNamePods = F2(
	function (prefix, list) {
		return A2(
			_elm_lang$core$List$filter,
			function (m) {
				return A2(_elm_lang$core$String$startsWith, prefix, m.name);
			},
			list);
	});
var _user$project$Main$filterNamePrefix = F2(
	function (prefix, list) {
		return A2(
			_elm_lang$core$List$filter,
...
var _user$project$Main$greater = F2(
	function (a, b) {
		return (_elm_lang$core$Native_Utils.cmp(a, b) > 0) ? a : b;
	});
var _user$project$Main$renderIng2Svcs = F2(
	function (ings, collage) {
		var render_ing2svcs = function (ing) {
			var end = function (path) {
				return A3(
					_timjs$elm_collage$Collage_Layout$locate,
					A2(_elm_lang$core$Basics_ops['++'], 'svc-', path.backend),
					_timjs$elm_collage$Collage_Layout$top,
					collage);
			};
			var san_name = function (name) {
				return A3(_elm_community$string_extra$String_Extra$replace, '/', '', name);
			};
			...
			var render_path2svc = function (path) {
				return A2(
					_timjs$elm_collage$Collage_Layout$name,
					A2(
						_elm_lang$core$Basics_ops['++'],
					...
					A2(
						...
						A2(
							_timjs$elm_collage$Collage$dot,
							_timjs$elm_collage$Collage$thick,
							_timjs$elm_collage$Collage$uniform(_elm_lang$core$Color$yellow)),
						A2(
							_timjs$elm_collage$Collage$segment,
							A2(
								_elm_lang$core$Maybe$withDefault,
		...
		return _timjs$elm_collage$Collage_Layout$stack(
			A2(_elm_lang$core$List$map, render_ing2svcs, ings));
	});
var _user$project$Main$renderFrameAround = F3(
	function (prefix, name, inner_content) {
		var san_name = A3(_elm_community$string_extra$String_Extra$replace, '/', '', name);
		var label = _timjs$elm_collage$Collage_Layout$center(
			A2(
				_timjs$elm_collage$Collage_Layout$name,
				A2(
					_elm_lang$core$Basics_ops['++'],
					'label-',
					A2(_elm_lang$core$Basics_ops['++'], prefix, san_name)),
				_timjs$elm_collage$Collage$rendered(
					_timjs$elm_collage$Collage_Text$fromString(name))));
		var content = _timjs$elm_collage$Collage_Layout$vertical(
			{
				ctor: '::',
				_0: label,
				_1: {
		...
		var frame = _timjs$elm_collage$Collage_Layout$center(
			A2(
				_timjs$elm_collage$Collage_Layout$name,
				A2(_elm_lang$core$Basics_ops['++'], prefix, san_name),
				A2(
					_timjs$elm_collage$Collage$filled,
					_timjs$elm_collage$Collage$transparent,
					A2(
						_timjs$elm_collage$Collage$rectangle,
						_timjs$elm_collage$Collage_Layout$width(content),
						_timjs$elm_collage$Collage_Layout$height(content)))));
		return _timjs$elm_collage$Collage_Layout$stack(
			A2(
				_elm_lang$core$List$map,
				_timjs$elm_collage$Collage_Layout$center,
				{
					ctor: '::',
					_0: content,
					_1: {
...
var _user$project$Main$renderEmptyFrame = F4(
	function (x, y, prefix, name) {
		var san_name = A3(_elm_community$string_extra$String_Extra$replace, '/', '', name);
		var frame = _timjs$elm_collage$Collage_Layout$center(
			A2(
				_timjs$elm_collage$Collage_Layout$name,
				...
				A2(
					_timjs$elm_collage$Collage$filled,
					_timjs$elm_collage$Collage$transparent,
					A2(_timjs$elm_collage$Collage$rectangle, x, y))));
		var label = _timjs$elm_collage$Collage_Layout$center(
			A2(
				_timjs$elm_collage$Collage_Layout$name,
				A2(
...
var _user$project$Main$hasLabels = F2(
	function (labels, pod) {
		var kv_present = F2(
			function (key, value) {
				return _elm_lang$core$Native_Utils.eq(
					A2(
						_elm_lang$core$Maybe$withDefault,
						'',
						A2(_elm_lang$core$Dict$get, key, pod.labels)),
					value);
			});
		return !_elm_lang$core$Dict$isEmpty(
			A2(_elm_lang$core$Dict$filter, kv_present, labels));
	});
var _user$project$Main$filterPods = F2(
	function (labels, pods) {
		return (!_elm_lang$core$Dict$isEmpty(labels)) ? A2(
			_elm_lang$core$List$filter,
			function (l) {
				return _elm_lang$core$Native_Utils.eq(l.phase, 'Running');
			},
			A2(
				_elm_lang$core$List$filter,
				function (l) {
					return _elm_lang$core$Native_Utils.eq(l.deletionTimestamp, _elm_lang$core$Maybe$Nothing);
				},
				A2(
					_elm_lang$core$List$filter,
					_user$project$Main$hasLabels(labels),
					pods))) : {ctor: '[]'};
	});
var _user$project$Main$renderSvcs2Pods = F3(
	function (pods, svcs, collage) {
		var selected_pods = function (svc) {
			return A2(
				_user$project$Main$filterPods,
				A2(_elm_lang$core$Maybe$withDefault, _elm_lang$core$Dict$empty, svc.selectors),
				pods);
		};
		var get_start = function (svc) {
			return A3(
				_timjs$elm_collage$Collage_Layout$locate,
				A2(_elm_lang$core$Basics_ops['++'], 'svc-', svc.name),
				_timjs$elm_collage$Collage_Layout$bottom,
				collage);
		};
		var get_points = function (svc) {
			return A2(
				_elm_lang$core$List$map,
				function (l) {
					return A3(
						_timjs$elm_collage$Collage_Layout$locate,
						A2(_elm_lang$core$Basics_ops['++'], 'pod-', l),
						_timjs$elm_collage$Collage_Layout$top,
						collage);
				},
				A2(
		...
		var render_svc2pods = function (svc) {
			return A2(
				_timjs$elm_collage$Collage_Layout$name,
				A2(_elm_lang$core$Basics_ops['++'], 'svc2pods-', svc.name),
		...
		return _timjs$elm_collage$Collage_Layout$stack(
			A2(_elm_lang$core$List$map, render_svc2pods, svcs));
	});
...
var _user$project$Main$emptyPod = {
	name: '',
	labels: _elm_lang$core$Dict$empty,
	owner: '',
	phase: '',
	conditions: {ctor: '[]'}
};
var _user$project$Main$pod_width = 100;
var _user$project$Main$renderPod = function (pod) {
	var get_status = _elm_lang$core$Native_Utils.eq(pod.deletionTimestamp, _elm_lang$core$Maybe$Nothing) ? 'good' : 'bad';
	var podc = A2(
		_timjs$elm_collage$Collage_Layout$name,
		A2(_elm_lang$core$Basics_ops['++'], 'pod-', pod.name),
		A2(
			_timjs$elm_collage$Collage$filled,
			_timjs$elm_collage$Collage$transparent,
			A2(_timjs$elm_collage$Collage$rectangle, _user$project$Main$pod_width, _user$project$Main$pod_width)));
	return A2(
		_timjs$elm_collage$Collage_Layout$name,
		A2(
			_elm_lang$core$Basics_ops['++'],
			...
			A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						get_status,
						A2(_elm_lang$core$Basics_ops['++'], '-', pod.name))))),
...
var _user$project$Main$pod_margin = 25;
var _user$project$Main$wrap = function (list) {
	var space = A2(_timjs$elm_collage$Collage_Layout$spacer, _user$project$Main$pod_margin, _user$project$Main$pod_margin);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		{
			ctor: '::',
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$List$intersperse, space, list),
			{
				ctor: '::',
				_0: space,
				_1: {ctor: '[]'}
...
var _user$project$Main$wrapItem = function (item) {
	var space = A2(_timjs$elm_collage$Collage_Layout$spacer, _user$project$Main$pod_margin, _user$project$Main$pod_margin);
	return {
		ctor: '::',
		_0: space,
...
var _user$project$Main$wrapH = function (list) {
	var space = A2(_timjs$elm_collage$Collage_Layout$spacer, _user$project$Main$pod_margin, _user$project$Main$pod_margin);
	return _timjs$elm_collage$Collage_Layout$center(
		_timjs$elm_collage$Collage_Layout$vertical(
			A2(
				_elm_lang$core$List$map,
				_timjs$elm_collage$Collage_Layout$align(_timjs$elm_collage$Collage_Layout$left),
				_user$project$Main$wrapItem(
					_timjs$elm_collage$Collage_Layout$horizontal(
						A2(
							_elm_lang$core$List$map,
							_timjs$elm_collage$Collage_Layout$align(_timjs$elm_collage$Collage_Layout$top),
							A2(
								_elm_lang$core$Basics_ops['++'],
								{
									ctor: '::',
...
var _user$project$Main$renderSvcs = function (svcs) {
	return _user$project$Main$wrapH(
		A2(
			_elm_lang$core$List$map,
			function (l) {
				return A4(_user$project$Main$renderEmptyFrame, 200, 50, 'svc-', l.name);
			},
			svcs));
};
var _user$project$Main$renderIngPaths = function (ing) {
	return _user$project$Main$wrapH(
		A2(
			_elm_lang$core$List$map,
			function (l) {
				return A4(_user$project$Main$renderEmptyFrame, 100, 25, 'ing-path-', l.path);
			},
			A2(
...
var _user$project$Main$renderIngs = function (ings) {
	var render_ing = function (ing) {
		var paths = _timjs$elm_collage$Collage_Layout$center(
			_user$project$Main$renderIngPaths(ing));
		return A3(_user$project$Main$renderFrameAround, 'ing-', ing.name, paths);
	};
	return _timjs$elm_collage$Collage_Layout$center(
		_user$project$Main$wrapH(
			A2(_elm_lang$core$List$map, render_ing, ings)));
};
var _user$project$Main$wrapV = function (list) {
	var space = A2(_timjs$elm_collage$Collage_Layout$spacer, _user$project$Main$pod_margin, _user$project$Main$pod_margin);
	return _timjs$elm_collage$Collage_Layout$center(
		_timjs$elm_collage$Collage_Layout$horizontal(
			A2(
...
var _user$project$Main$renderReplicaSet = F2(
	function (pods, name) {
		var podsc = A2(
			_timjs$elm_collage$Collage_Layout$align,
			_timjs$elm_collage$Collage_Layout$base,
			_timjs$elm_collage$Collage_Layout$vertical(
				_user$project$Main$wrapItem(
					_timjs$elm_collage$Collage_Layout$horizontal(
						_user$project$Main$wrap(
							A2(
								_elm_lang$core$List$map,
								_user$project$Main$renderPod,
								A2(_user$project$Main$filterNamePods, name, pods)))))));
		var label = A2(
			_timjs$elm_collage$Collage_Layout$name,
			A2(_elm_lang$core$Basics_ops['++'], 'label-rs-', name),
			A2(
				_timjs$elm_collage$Collage$shiftY,
				(_timjs$elm_collage$Collage_Layout$height(podsc) / 2) - (_user$project$Main$pod_margin / 2),
				_timjs$elm_collage$Collage$rendered(
					_timjs$elm_collage$Collage_Text$fromString(name))));
		var rs = A2(
			_timjs$elm_collage$Collage_Layout$name,
			A2(_elm_lang$core$Basics_ops['++'], 'rs-', name),
			A2(
				_timjs$elm_collage$Collage_Layout$align,
				_timjs$elm_collage$Collage_Layout$base,
				A2(
					...
					A2(
						_timjs$elm_collage$Collage$rectangle,
						A2(
							_user$project$Main$greater,
							_timjs$elm_collage$Collage_Layout$width(podsc),
							_timjs$elm_collage$Collage_Layout$width(label)),
						_timjs$elm_collage$Collage_Layout$height(podsc)))));
		return _timjs$elm_collage$Collage_Layout$stack(
			{
				ctor: '::',
				_0: label,
...
var _user$project$Main$renderDeployment = F3(
	function (replicasets, pods, name) {
		var rs = _user$project$Main$wrapH(
			A2(
				_elm_lang$core$List$map,
				_user$project$Main$renderReplicaSet(
					A2(_user$project$Main$filterNamePods, name, pods)),
				A2(_user$project$Main$filterNamePrefix, name, replicasets)));
		return A3(_user$project$Main$renderFrameAround, 'dep-', name, rs);
	});
var _user$project$Main$renderAll = F5(
	function (deployments, replicasets, pods, svcs, ings) {
		var deps = _user$project$Main$wrapH(
			A2(
				_elm_lang$core$List$map,
				A2(_user$project$Main$renderDeployment, replicasets, pods),
				deployments));
		var resources = _user$project$Main$wrapV(
			{
				ctor: '::',
				_0: _user$project$Main$renderIngs(ings),
				_1: {
					ctor: '::',
					_0: _user$project$Main$renderSvcs(svcs),
					_1: {
						ctor: '::',
						_0: deps,
						_1: {ctor: '[]'}
		...
		var traffic = A2(
			...
			{
				ctor: '::',
				_0: A3(_user$project$Main$renderSvcs2Pods, pods, svcs, resources),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(_user$project$Main$renderIng2Svcs, ings, resources),
				_1: {ctor: '[]'}
			});
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('lists'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_user$project$Main$renderList,
				'Services',
				A2(
					_elm_lang$core$List$map,
					function (_) {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A2(_user$project$Main$renderList, 'Deployments: ', model.deployments),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Main$renderList, 'ReplicaSets: ', model.replicasets),
						_1: {
							ctor: '::',
							_0: A2(
								_user$project$Main$renderList,
							...
							_1: {
								ctor: '::',
								_0: A5(_user$project$Main$renderAll, model.deployments, model.replicasets, model.pods, model.svcs, model.ings),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Main$namespace = 'default';
var _user$project$Main$api_server = 'http://localhost:8001/k8s-api';
var _user$project$Main$end_deployments = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$Main$api_server,
	A2(
		_elm_lang$core$Basics_ops['++'],
		'/apis/apps/v1beta2/namespaces/',
		A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$namespace, '/deployments')));
var _user$project$Main$end_pods = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$Main$api_server,
	A2(
		_elm_lang$core$Basics_ops['++'],
		'/api/v1/namespaces/',
		A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$namespace, '/pods')));
var _user$project$Main$end_replicasets = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$Main$api_server,
	A2(
		_elm_lang$core$Basics_ops['++'],
		'/apis/apps/v1beta2/namespaces/',
		A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$namespace, '/replicasets')));
var _user$project$Main$end_svcs = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$Main$api_server,
	A2(
		_elm_lang$core$Basics_ops['++'],
		'/api/v1/namespaces/',
		A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$namespace, '/services')));
var _user$project$Main$end_ings = A2(
	_elm_lang$core$Basics_ops['++'],
	_user$project$Main$api_server,
	A2(
		_elm_lang$core$Basics_ops['++'],
		'/apis/extensions/v1beta1/namespaces/',
		A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$namespace, '/ingresses')));
var _user$project$Main$Metadata = function (a) {
	return {name: a};
};
var _user$project$Main$Pod = F6(
	function (a, b, c, d, e, f) {
		return {name: a, labels: b, owner: c, phase: d, conditions: e, deletionTimestamp: f};
	});
var _user$project$Main$podDecoder = A2(
	_elm_lang$core$Json_Decode$field,
	'items',
	_elm_lang$core$Json_Decode$list(
		A7(
			_elm_lang$core$Json_Decode$map6,
			_user$project$Main$Pod,
			A2(
				_elm_lang$core$Json_Decode$at,
				{
					ctor: '::',
			...
			_elm_lang$core$Json_Decode$maybe(
				A2(
					_elm_lang$core$Json_Decode$at,
					{
						...
						_1: {
							ctor: '::',
							_0: 'deletionTimestamp',
							_1: {ctor: '[]'}
						}
					},
					_elm_lang$core$Json_Decode$string)))));
var _user$project$Main$Ing = F2(
	function (a, b) {
		return {name: a, http_paths: b};
	});
var _user$project$Main$IngPath = F2(
	function (a, b) {
		return {path: a, backend: b};
	});
var _user$project$Main$ingDecoder = A2(
	_elm_lang$core$Json_Decode$field,
	'items',
	_elm_lang$core$Json_Decode$list(
		A3(
			_elm_lang$core$Json_Decode$map2,
			_user$project$Main$Ing,
			A2(
				_elm_lang$core$Json_Decode$at,
				{
					ctor: '::',
						...
						_elm_lang$core$Json_Decode$list(
							A3(
								...
								A2(
									...
									_elm_lang$core$Json_Decode$string)))))))));
var _user$project$Main$Svc = F2(
	function (a, b) {
		return {name: a, selectors: b};
	});
var _user$project$Main$svcDecoder = A2(
	_elm_lang$core$Json_Decode$field,
	'items',
	_elm_lang$core$Json_Decode$list(
		A3(
			_elm_lang$core$Json_Decode$map2,
			_user$project$Main$Svc,
			A2(
				_elm_lang$core$Json_Decode$at,
				{
					ctor: '::',
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {deployments: a, replicasets: b, pods: c, svcs: d, ings: e};
	});
var _user$project$Main$PodLight = F3(
	function (a, b, c) {
		return {name: a, labels: b, owner: c};
	});
var _user$project$Main$NewReplicaSets = function (a) {
	return {ctor: 'NewReplicaSets', _0: a};
};
var _user$project$Main$getReplicaSets = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$NewReplicaSets,
	A2(_elm_lang$http$Http$get, _user$project$Main$end_replicasets, _user$project$Main$itemsNameDecoder));
var _user$project$Main$NewDeployments = function (a) {
	return {ctor: 'NewDeployments', _0: a};
};
var _user$project$Main$getDeployments = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$NewDeployments,
	A2(_elm_lang$http$Http$get, _user$project$Main$end_deployments, _user$project$Main$itemsNameDecoder));
var _user$project$Main$NewIngs = function (a) {
	return {ctor: 'NewIngs', _0: a};
};
var _user$project$Main$getIngs = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$NewIngs,
	A2(_elm_lang$http$Http$get, _user$project$Main$end_ings, _user$project$Main$ingDecoder));
var _user$project$Main$NewSvcs = function (a) {
	return {ctor: 'NewSvcs', _0: a};
};
var _user$project$Main$getSvcs = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$NewSvcs,
	A2(_elm_lang$http$Http$get, _user$project$Main$end_svcs, _user$project$Main$svcDecoder));
var _user$project$Main$NewPods = function (a) {
	return {ctor: 'NewPods', _0: a};
};
var _user$project$Main$getPods = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$NewPods,
	A2(_elm_lang$http$Http$get, _user$project$Main$end_pods, _user$project$Main$podDecoder));
var _user$project$Main$init = {
	...
	_0: A5(
		...
		{ctor: '[]'},
		{ctor: '[]'}),
	_1: _user$project$Main$getPods
};
var _user$project$Main$GetReplicaSets = {ctor: 'GetReplicaSets'};
var _user$project$Main$GetDeployments = {ctor: 'GetDeployments'};
var _user$project$Main$GetIngs = {ctor: 'GetIngs'};
var _user$project$Main$GetSvcs = {ctor: 'GetSvcs'};
var _user$project$Main$GetPods = {ctor: 'GetPods'};
		...
		switch (_p0.ctor) {
			case 'Refresh':
				return A3(
					...
					_user$project$Main$GetIngs,
					A3(
						_ccapndave$elm_update_extra$Update_Extra$andThen,
						_user$project$Main$update,
						_user$project$Main$GetSvcs,
						A3(
							_ccapndave$elm_update_extra$Update_Extra$andThen,
							_user$project$Main$update,
							_user$project$Main$GetReplicaSets,
							A3(
								_ccapndave$elm_update_extra$Update_Extra$andThen,
								_user$project$Main$update,
								_user$project$Main$GetDeployments,
								A3(
									_ccapndave$elm_update_extra$Update_Extra$andThen,
									_user$project$Main$update,
									_user$project$Main$GetPods,
									A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										model,
										{ctor: '[]'}))))));
							...
							A3(
								...
								A3(
									...
									A2(
										...
										{ctor: '[]'}))))));
			case 'GetDeployments':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Main$getDeployments};
			case 'GetPods':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Main$getPods};
			case 'GetSvcs':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Main$getSvcs};
			case 'GetIngs':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Main$getIngs};
			case 'GetReplicaSets':
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Main$getReplicaSets};
			case 'NewPods':
				if (_p0._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
